...
export default function Workspace({ onAnalyze, isLoading, selectedDemo = null, onSelectDemo }: WorkspaceProps) {
  ...
  const handleToggleListening = () => {
    if (!recognition) {
      setSpeechError('Speech recognition is not supported in this browser. Type or paste your tasks instead.');
      return;
    }
    ...
    try {
      ...
      setSpeechError('Voice input could not start in this browser. Type or paste your tasks instead.');
      setIsListening(false);
    }
  };
    ...
    <div id="sandbox-workbench" className="bg-theme-card border border-theme-border/80 rounded-2xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 pb-6 border-b border-theme-border/50">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            <GraduationCap className="w-3.5 h-3.5 pointer-events-none" />
          ...
          >
            <BriefcaseBusiness className="w-3.5 h-3.5 pointer-events-none" />
          ...
          >
            <Rocket className="w-3.5 h-3.5 pointer-events-none" />
